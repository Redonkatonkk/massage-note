...
当前版本：`0.6.13`。后续任何 AI 修补或开发都必须在同一次修改中迭代版本号；完整规则见[《AI 接管与修改指南》](docs/AI_HANDOFF.md)。
...
- 全中文响应式今日表格、快速记工、同一员工多笔待结账、项目时长变化时自动重算下工时间、按最晚记工时间显示“空闲/下工时间”、手机自适应详情、非阻塞保存、排序、隐藏、软删除与恢复。
...
- 财务筛选、带词条解释与公式提示的精简汇总卡片、可追溯明细、CSV 导出、管理页和完整审计查询。
