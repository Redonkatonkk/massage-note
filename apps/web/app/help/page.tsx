...
export default function HelpPage() {
  return <main className="help-shell">
    ...
    <section className="help-grid">
      <article className="help-card"><h2>当天记工</h2><ol><li>在员工行点“快速记工”。</li><li>选择主要项目，再选择该项目的时长和价格；需要时填写实际开始时间。</li><li>先保存即可开工，记录会显示“待结账”。</li><li>客人付款后打开详情，现金大费和刷卡大费至少填一项；现金小费和刷卡小费都可以留空，系统按 0 计算并结算。</li></ol><p>店长和经理可在“店铺设置”中为同一个项目维护多个时长价格，无需重复创建项目。当天的有效成员都能帮助任何员工新增或纠正当天记录。历史营业日只能由店主或经理在取消日结后修改。</p></article>
      <article className="help-card"><h2>打卡与今日表格</h2><ul><li>参与记工的店主、经理和员工都能上下班打卡，成功后页面会显示绿色提示。</li><li>“加入今日”只影响当天表格，不会删除成员，也不会被当作已经上班。</li><li>新营业日重新打卡时，系统会自动结束本人遗留在旧营业日的未下班记录并保留审计。</li><li>拖动排序、隐藏、打卡和记工变化会同步到其他已登录设备。</li><li>断网时不要重复提交；页面会保留已编辑草稿，联网后再保存。</li></ul></article>
    ...
    <section className="help-grid">
      <article className="help-card"><h2>项目与提成</h2><p>主要、额外和折扣项目在“店铺设置 → 项目与提成”中分开维护，每一类都能独立新增、上移或下移。系统依次寻找：员工对该项目的专属提成 → 项目默认提成 → 员工默认提成 → 全店默认提成。记工保存后会留下项目、价格和提成快照，以后修改设置不会改变历史。</p></article>
