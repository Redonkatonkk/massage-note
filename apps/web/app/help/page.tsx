...
export default function HelpPage() {
  return <main className="help-shell">
    ...
    <section className="help-grid">
      ...
      <article className="help-card"><h2>工作状态与今日表格</h2><ul><li>今日页面不需要上班或下班打卡；店长或经理可以用“加入今日”安排当天参与记工的员工。</li><li>当前没有进行中的记工显示“空闲”；当前正在服务时显示预计的下工时间，状态会随时间自动更新。</li><li>“加入今日”只影响当天表格，不会删除成员或改变历史记工。</li><li>员工可在今日页面选择过去营业日查看自己的记工；历史页面只显示本人资料并且不能修改。</li><li>员工页面不显示全店大费、小费、员工应得和待结账汇总。</li><li>拖动排序、隐藏和记工变化会同步到其他已登录设备。</li><li>断网时不要重复提交；页面会保留已编辑草稿，联网后再保存。</li></ul></article>
    ...
    <section className="help-grid">
      <article className="help-card"><h2>项目、折扣与提成</h2><p>主要、额外和折扣项目在“店铺设置 → 项目与提成”中分开维护，每一类都能独立新增、上移或下移。店长还可以在基础店铺设置中开启周一至周四自动折扣，设置折前大费门槛和固定减免额度。自动折扣与其他折扣一起降低店铺折后业绩，但不会减少员工大费工资。系统依次寻找：员工对该项目的专属提成 → 项目默认提成 → 员工默认提成 → 全店默认提成。记工保存后会留下项目、价格、折扣和提成快照。</p></article>
