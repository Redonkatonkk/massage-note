...
function MembersPanel({ storeId, dailyRankingEnabled, currentRole, members, requests, catalog, busy, run, reload }: { storeId: string; dailyRankingEnabled: boolean; currentRole: MembershipSummary["role"]; members: StoreMember[]; requests: JoinRequest[]; catalog: CatalogResponse; busy: boolean; run: (action: () => Promise<void>) => Promise<void>; reload: () => Promise<void> }) {
