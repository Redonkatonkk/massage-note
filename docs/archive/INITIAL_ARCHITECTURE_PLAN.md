...
> **归档文档**：这是 2026-08-04 编码前确认的初始设计与分阶段计划。路由、模块和测试工具已有变化，请勿用它判断当前实现。当前架构见 [`../ARCHITECTURE.md`](../ARCHITECTURE.md)，当前产品规则见 [`../PRODUCT.md`](../PRODUCT.md)。原状态：已确认，2026-08-04 开始实施；原依据：产品需求与已确认的补充规则。
